;(function($){
	...
	$( function(){
		...
		$('.slider-toolbar-carousel .cactus-sub-wrap').each(function(index, element) {
			...
			var $buttonPrev = $this.parents('.slider-toolbar').find('.prev-slide');
			var $buttonNext = $this.parents('.slider-toolbar').find('.next-slide');
		...
		$('#open-report, #submitReport').on('click', function(){
			$('#submitReport').toggleClass('active');
			return false;
		});

		// $('#submitReport .close').on('click', function(){

		// 	if($('#submitReport').hasClass('active')){
		// 		// $('#submitReport').removeClass('active');
		// 	}
		// });
		...
		/*like action*/
			$('.action-like .jlk').on('click', function(){
				...
				$(this).find('span').css({'background-color':cactus.videoflix_main_color, 'color':'#FFFFFF'});
	...
	$('#comments_open').on('click', function(e){
		$('#single-comments-form').toggleClass('show');

		$(".live-comment").mCustomScrollbar({
	...
	$('#single-comments-form .close').on('click', function(e){
		$('#single-comments-form').removeClass('show');
